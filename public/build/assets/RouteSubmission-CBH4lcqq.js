...
import{r as l,_ as ue,j as e,$ as me,Y as he,c as N}from"./app-BRVKEMDs.js";N.defaults.baseURL="/";N.defaults.withCredentials=!0;function pe({driver:L,freights:O,routes:ie,users:E}){const[ge,I]=l.useState(null),[m,S]=l.useState(null),[h,T]=l.useState(null),[i,M]=l.useState(null),[X,Y]=l.useState(!1),[z,G]=l.useState(null),[A,W]=l.useState(null),[B,Z]=l.useState(null),[Q,x]=l.useState(null),[o,F]=l.useState(null),[H,J]=l.useState(!0),[U,ee]=l.useState(!1),[K,D]=l.useState(!1),[R,$]=l.useState(null),[j,q]=l.useState({weight:"",customer_id:""}),_=l.useRef(null),C=l.useRef(0),f=l.useRef(null),[b,P]=l.useState({name:"",freight_id:"",pricing:""});l.useEffect(()=>{const t=document.createElement("link");t.rel="stylesheet",t.href="https://cdnjs.cloudflare.com/ajax/libs/leaflet/1.7.1/leaflet.css",document.head.appendChild(t);const s=document.createElement("link");s.rel="stylesheet",s.href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.1.1/css/all.min.css",document.head.appendChild(s);const a=document.createElement("style");return a.textContent=`
            .custom-marker {
                display: flex;
                align-items: center;
