...
use App\Filament\Resources\RoutePointsResource\Pages;
use App\Filament\Resources\RoutePointsResource\RelationManagers;
...
class RoutePointsResource extends Resource
{
    protected static ?string $model = RoutePoints::class;
    ...
    {
        return [
            'index' => Pages\ListRoutePoints::route('/'),
            'create' => Pages\CreateRoutePoints::route('/create'),
            'edit' => Pages\EditRoutePoints::route('/{record}/edit'),
        ];
    }
}
